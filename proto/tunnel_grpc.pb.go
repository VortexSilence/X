...
const (
	TunnelService_Stream_FullMethodName = "/tun.TunnelService/Stream"
)
...
type TunnelServiceClient interface {
	Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelPacket, TunnelPacket], error)
}
...
func (c *tunnelServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelPacket, TunnelPacket], error) {
...
type TunnelService_StreamClient = grpc.BidiStreamingClient[TunnelPacket, TunnelPacket]

// TunnelServiceServer is the server API for TunnelService service.
// All implementations must embed UnimplementedTunnelServiceServer
// for forward compatibility.
type TunnelServiceServer interface {
	Stream(grpc.BidiStreamingServer[TunnelPacket, TunnelPacket]) error
...
func (UnimplementedTunnelServiceServer) Stream(grpc.BidiStreamingServer[TunnelPacket, TunnelPacket]) error {
...
func _TunnelService_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).Stream(&grpc.GenericServerStream[TunnelPacket, TunnelPacket]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_StreamServer = grpc.BidiStreamingServer[TunnelPacket, TunnelPacket]
